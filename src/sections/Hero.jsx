  ...
  return (
    <section id="home" className="p-5 pt-[5rem] max-container w-full flex justify-between items-center  text-white">
      ...
      <div className="p-3 my-10 rounded-lg z-10 flex  max-contain w-1/2 justify-center m-2 items-end max-lg:hidden ">
        <img src="me3.jpg" alt="Dex" className="w-[60%] object-contain shadow-xl rounded-full bg-black border-gray-500 border-3"/>
      </div>

      <div className="flex flex-col px-20 rounded-lg w-1/2 justify-center max-md:p-0 max-lg:w-full pb-11 shadow-xl">
